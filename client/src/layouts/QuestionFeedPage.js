    ...
    <React.Fragment>
      <Grid container justify='flex-end'>
        <LinkCustom to='./dashboard'>
          <ButtonCustom hasArrow>Return to Dashboard</ButtonCustom>
        </LinkCustom>
      </Grid>
      <Grid item container justify='center' className={classes.questionContainer}>
        <Grid item container xs={12} sm={6} justify='center'>
          <Question />
          <Grid item container xs={12} justify='center' className={classes.stepperContainer}>
